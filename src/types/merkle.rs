...
use crate::types::{hash_concat, Bytes32};

/// Tree depth
pub const TREE_DEPTH: usize = 32;
pub const MAX_LEAFS: usize = ((1u64 << TREE_DEPTH as u64) - 1) as usize;
...
pub const ZERO_HASHES: [Hash; TREE_DEPTH] = [
    Z_0, Z_1, Z_2, Z_3, Z_4, Z_5, Z_6, Z_7, Z_8, Z_9, Z_10, Z_11, Z_12, Z_13, Z_14, Z_15, Z_16,
    Z_17, Z_18, Z_19, Z_20, Z_21, Z_22, Z_23, Z_24, Z_25, Z_26, Z_27, Z_28, Z_29, Z_30, Z_31,
];
...
impl MerkleTree {
    ...
    pub fn branch(&self) -> &[Hash; TREE_DEPTH] {
        &self.branch
    }
    ...
    pub fn root(&self) -> Hash {
        self.merkle_root_with_ctx(ZERO_HASHES)
    }

    /// Calculates and returns the current trees root given an array of zero hashes
    fn merkle_root_with_ctx(&self, ctx: [Hash; TREE_DEPTH]) -> Hash {
